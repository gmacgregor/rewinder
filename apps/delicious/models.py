...
class Bookmark(models.Model):
    ...
    url                     = models.URLField()
    tags                    = TagField()
    image                   = models.ImageField(upload_to='img/links/%Y%m/', blank=True)
    image_caption           = models.TextField(blank=True, help_text=u'Use Markdown syntax for HTML formatting.')
