...
urlpatterns = patterns('',
    url(r'^categories/all/$', 'django.views.generic.list_detail.object_list', dict(category_dict), name='blog_category_list'),
    url(r'^categories/(?P<slug>[-\w]+)/$', 'django.views.generic.list_detail.object_detail', dict(category_dict, template_object_name='category'), name='blog_category_detail'),
)
