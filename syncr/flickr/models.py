...
class Photo(models.Model):
    ...
    exif_software = models.CharField(max_length=200, blank=True) #incrased length to 200 -- ie. Adobe Photoshop CS3 (10.0x20061208 [20061208.beta.1251 2006/12/08:02:00:00 cutoff; m branch])  Macintosh
