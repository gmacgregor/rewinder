...
class FlickrSyncr:
    ...
    def _syncPhoto(self, photo_xml, refresh=False):
        ...
        try:
            ...
            photo_default_title =photo_xml.photo[0].title[0].text
            photo_default_description = photo_xml.photo[0].description[0].text
        except:
            proposed_slug = 'untitled'
            photo_default_title = 'Untitled'
            photo_default_description = ''
        ...
        default_dict = {
            ...
            'title': photo_default_title, # TODO: Typography
            'slug': slug,
            'description': photo_default_description,
